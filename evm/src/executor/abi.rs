...
ethers::contract::abigen!(
    ...
    r#"[
            ...
            envBoolArr(string)(bool[])
            envUintArr(string)(uint256[])
            envIntArr(string)(int256[])
            envAddressArr(string)(address[])
            envBytes32Arr(string)(bytes32[])
            envStringArr(string)(string[])
            envBytesArr(string)(bytes[])
