...
ethers::contract::abigen!(
    ...
    r#"[
            ...
            envWithDefault(string,uint256)(uint256)
            envWithDefault(string,int256)(int256)
            envWithDefault(string,address)(address)
            envWithDefault(string,bytes32)(bytes32)
            envWithDefault(string,string)(string)
            envWithDefault(string,bytes)(bytes)
            envWithDefault(string,string,bool[])(bool[])
            envWithDefault(string,string,uint256[])(uint256[])
            envWithDefault(string,string,int256[])(int256[])
            envWithDefault(string,string,address[])(address[])
            envWithDefault(string,string,bytes32[])(bytes32[])
            envWithDefault(string,string,string[])(string[])
            envWithDefault(string,string,bytes[])(bytes[])
