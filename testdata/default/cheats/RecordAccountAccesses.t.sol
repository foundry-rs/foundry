...
contract RecordAccountAccessesTest is Test {
    ...
    function testRecordAccountAccesses() public {
        ...
        expectedStateDiff =
            string.concat(expectedStateDiff, "\ncontract: default/vm/RecordAccountAccesses.t.sol:SelfCaller");
