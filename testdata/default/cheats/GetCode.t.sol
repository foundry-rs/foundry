...
contract GetCodeTest is DSTest {
    ...
    function testGetCode() public {
        bytes memory fullPath = vm.getCode(
            "fixtures/GetCode/WorkingContract.json"
        );
    ...
    function testGetCodeHardhatArtifact() public {
        bytes memory fullPath = vm.getCode(
            "fixtures/GetCode/HardhatWorkingContract.json"
        );
    ...
    */
    ...
    function testWithVersion() public {
        bytes memory code = vm.getCode(
            "cheats/GetCode.t.sol:TestContract:0.8.18"
        );
