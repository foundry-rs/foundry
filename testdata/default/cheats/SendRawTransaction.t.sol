...
contract SendRawTransactionTest is DSTest {
    ...
    function test_revert_not_a_tx() public {
        vm.expectRevert("sendRawTransaction: error decoding transaction (unexpected string)");
        vm.sendRawTransaction(hex"0102");
    }

    function test_revert_missing_signature() public {
        vm.expectRevert("sendRawTransaction: error decoding transaction (input too short)");
        vm.sendRawTransaction(hex"dd806483030d40940993863c19b0defb183ca2b502db7d1b331ded757b80");
    }
    ...
    // i ran into an issue where the test would fail after running `sendRawTransaction`
