...
contract AssertionsTest is DSTest {
    ...
    function testAssertApproxEqRel() public {
        ...
        vm._expectCheatcodeRevert(bytes(string.concat(errorMessage, ": 1 !~= 0 (max delta: 0.0000000000000000%, real delta: undefined)")));
        ...
        vm._expectCheatcodeRevert(bytes("assertion failed: 1 !~= 0 (max delta: 0.0000000000000000%, real delta: undefined)"));
