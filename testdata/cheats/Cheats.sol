...
interface Cheats {
    ...
    function envWithDefault(string calldata, bool) external returns (bool);
    function envWithDefault(string calldata, uint256) external returns (uint256);
    function envWithDefault(string calldata, int256) external returns (int256);
    function envWithDefault(string calldata, address) external returns (address);
    function envWithDefault(string calldata, bytes32) external returns (bytes32);
    function envWithDefault(string calldata, string calldata) external returns (string memory);
    ...
    function envWithDefault(string calldata, string calldata, bytes[] calldata) external returns (bytes[] memory);
