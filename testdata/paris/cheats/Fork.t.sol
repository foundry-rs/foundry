...
contract ForkTest is DSTest {
    ...
    uint256 constant MAIN_BLOCK = 14_608_400;
    ...
    function setUp() public {
        forkA = VM.createFork("mainnet", MAIN_BLOCK);
        forkB = VM.createFork("mainnet2", MAIN_BLOCK - 1);
        testValue = 999;
    }
    ...
    function testForksHaveSeparatedStorage() public {
        ...
        bytes32 zeroAddressBalanceSlot = 0x3617319a054d772f909f7c479a2cebe5066e836a939412e32403c99029b92eff;
        VM.store(WETH_TOKEN_ADDR, zeroAddressBalanceSlot, value);
        assertEq(
