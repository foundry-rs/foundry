...
mod tests {
    ...
    fn upsert_inserts_and_updates() {
        ...
        // Update — cumulative changes, deposit preserved
        ...
        assert_eq!(channels["key1"].deposit, "100000"); // preserved
        assert_eq!(channels["key1"].created_at, created_at); // preserved
