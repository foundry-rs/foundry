use crate::abi::{
    EnsRegistry, EnsRegistry::recordExistsCall, NameWrapper, NameWrapper::isWrappedCall, Ownable,
    Ownable::ownerCall, PublicResolver, PublicResolver::addrCall, ReverseRegistrar,
};
...
use alloy_sol_types::{
    SolCall,
    private::{Address, B256, keccak256},
};
use eyre::Result;
...
/// gets the ENS reverse registrar address from the ENS registry
async fn get_reverse_registrar<P: Provider<AnyNetwork> + ProviderEnsExt<AnyNetwork, P>>(
    provider: &P,
) -> Result<Address> {
