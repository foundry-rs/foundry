use super::{OklinkSourceProvider, VerifyArgs};
...
#[derive(Debug)]
pub struct OklinkFlattenedSource;
impl OklinkSourceProvider for OklinkFlattenedSource {
    fn source(
        &self,
        args: &VerifyArgs,
        project: &Project,
        ...
        eyre::ensure!(
            ...
            "When using flattened source, bytecodeHash must be set to ipfs because Oklink uses IPFS in its Compiler Settings when re-compiling your code. BytecodeHash is currently: {}. Hint: Set the bytecodeHash key in your foundry.toml :)",
            bch,
        );
