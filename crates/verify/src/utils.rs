...
use alloy_rpc_types::{serde_helpers::WithOtherFields, Block, BlockId, Transaction};
use clap::ValueEnum;
...
pub fn configure_env_block(env: &mut Env, block: &WithOtherFields<Block<WithOtherFields<Transaction>>>) {
