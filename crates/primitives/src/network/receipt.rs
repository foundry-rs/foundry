        ...
        Ok(Self(WithOtherFields {
            inner: TransactionReceipt {
                ...
                inner: match r#type {
                    ...
                    ty if ty == TEMPO_TX_TYPE_ID => {
                        FoundryReceiptEnvelope::Tempo(receipt_with_bloom)
                    }
                    0x7E => {
