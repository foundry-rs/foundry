...
// forge soldeer update: same behavior as install looks up the config file and install all the dependencies that are present there. This will change in the future
// forge soldeer login: logs in into https://soldeer.xyz account
