...
pub struct TestArgs {
    ...
    /// Corpus mutation weight for crossover insertion.
    ...
    /// Corpus mutation weight for crossover replacement.
...
mod tests {
    ...
    fn fuzz_and_invariant_config_flags() {
        ...
        assert_eq!(config.fuzz.corpus.mutation_weights.mutation_weight_crossover_insert, 6);
        ...
        assert_eq!(config.invariant.corpus.mutation_weights.mutation_weight_crossover_replace, 8);
    }
