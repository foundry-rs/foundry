...
async fn test_core() {
    ...
    let results = runner.test_map(&Filter::new(".*", ".*", ".*core"), test_opts()).await;
...
async fn test_linking() {
    let mut runner = runner().await;
    let results = runner.test_map(&Filter::new(".*", ".*", ".*linking"), test_opts()).await;
...
async fn test_logs() {
    let mut runner = runner().await;
    let results = runner.test_map(&Filter::new(".*", ".*", ".*logs"), test_opts()).await;
...
async fn test_env_vars() {
    ...
    let _ = runner.test_map(&Filter::new("testSetEnv", ".*", ".*"), test_opts()).await;
...
async fn test_doesnt_run_abstract_contract() {
    let mut runner = runner().await;
    let results = runner
        .test_map(&Filter::new(".*", ".*", ".*Abstract.t.sol".to_string().as_str()), test_opts())
        .await;
...
async fn test_trace() {
    ...
    let suite_result = runner.test_map(&Filter::new(".*", ".*", ".*trace"), test_opts()).await;
