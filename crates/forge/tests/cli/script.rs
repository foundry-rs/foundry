...
Simulated On-chain Traces:
  ...
  [113512] → new Called@0x5FbDB2315678afecb367f032d93F642f64180aa3
    └─ ← [Return] 567 bytes of code

  [58577] Called::run(123, 456)
    ├─ emit log_string(val: "script ran")
    └─ ← [Stop]
