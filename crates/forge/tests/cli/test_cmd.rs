...
// // tests that `forge test` with a seed produces deterministic random values for uint and
// addresses. forgetest_init!(deterministic_randomness_with_seed, |prj, cmd| {
//     prj.wipe_contracts();
//     prj.add_test(
...
//     cmd.args(["test", "--mt", "testCheckDelegation",
// "-vvvv"]).assert_success().stdout_eq(str![[r#" ...
// Ran 1 test for test/Counter.t.sol:CounterTest
