use super::{bail, ensure, fmt_err, parse, Cheatcodes, Error, Result};
...
use foundry_evm_core::{abi::HEVMCalls, constants::MAGIC_SKIP_BYTES};
...
mod tests {
    use super::*;
    use crate::inspectors::CheatsConfig;
