...
impl TraceMode {
    ...
    pub fn with_verbosity(self, verbosity: u8) -> Self {
        match verbosity {
            ...
            // Don't promote past Debug — it already records everything and promoting
            // to RecordStateDiff would lose debug-specific features (immediate_bytes,
            // returndata snapshots).
