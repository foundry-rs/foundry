...
pub type EthRevmEvm<'db, I> = revmc::revm_evm::JitEvm<RawEthRevmEvm<'db, I>>;
...
impl FoundryEvmFactory for EthEvmFactory {
    ...
    type FoundryEvm<'db, I: FoundryInspectorExt<Self::FoundryContext<'db>>> =
        revmc::alloy_evm::JitEvm<&'db mut dyn DatabaseExt<Self>, I, Self::Precompiles>;
    ...
    fn create_foundry_evm_with_inspector<'db, I: FoundryInspectorExt<Self::FoundryContext<'db>>>(
        ...
        let mut eth_evm = revmc::alloy_evm::JitEvm::new(raw, true, jit_backend);
    ...
    fn create_foundry_nested_evm<'db>(
        ...
        eth_evm.cfg.tx_chain_id_check = true;
        eth_evm.inspector().get_networks().inject_precompiles(eth_evm.precompiles_mut());
        Box::new(revmc::revm_evm::JitEvm::new(
            eth_evm.into_inner(),
