...
async fn test_anvil_reset_fork_refreshes_inferred_fees() {
    ...
    london_a_api.mine_one().await.unwrap();
    ...
    london_b_api.mine_one().await.unwrap();
    ...
    berlin_a_api.mine_one().await.unwrap();
    ...
    berlin_b_api.mine_one().await.unwrap();
...
async fn test_anvil_failed_fork_reset_preserves_live_state() {
    ...
    .await;
    other_api.mine_one().await.unwrap();
