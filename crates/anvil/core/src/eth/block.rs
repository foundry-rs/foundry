        ...
        T: Into<Transaction>,
    {
        ...
        Self {
            header: Header {
                ...
                blob_gas_used: partial_header.blob_gas_used.map(|g| g as u64),
                excess_blob_gas: partial_header.excess_blob_gas.map(|g| g as u64),
                parent_beacon_block_root: partial_header.parent_beacon_block_root,
                nonce: partial_header.nonce,
                base_fee_per_gas: partial_header.base_fee.map(|g| g as u64),
                requests_root: None,
            },
            transactions,
            ommers,
...
impl From<Header> for PartialHeader {
    fn from(value: Header) -> Self {
        Self {
            ...
            nonce: value.nonce,
            base_fee: value.base_fee_per_gas.map(|g| g as u128),
            blob_gas_used: value.blob_gas_used.map(|g| g as u128),
            excess_blob_gas: value.excess_blob_gas.map(|g| g as u128),
