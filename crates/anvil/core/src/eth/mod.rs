...
pub enum EthRequest {
    ...
    /// reth's `debug_dbAncient` endpoint.
    #[serde(rename = "debug_dbAncient")]
    DebugDbAncient(String, u64),
...
true}]}"#;
    ...
    #[test]
    fn test_serde_debug_db_ancient() {
        let s = r#"{"method": "debug_dbAncient", "params": ["headers", 1]}"#;
        let value: serde_json::Value = serde_json::from_str(s).unwrap();
