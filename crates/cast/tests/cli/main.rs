...
// Smoke test that cast can replay a recent Base transaction with the Osaka EVM version.
// Keep this fixture recent enough for the public Base RPC to serve historical transaction data.
// <https://basescan.org/tx/0xcefd64d8c1ceff131bda5fb946b0767873f9833285820037b085564d4b4de53b>
casttest!(flaky_base_can_run_recent_tx_osaka, |_prj, cmd| {
    cmd.args([
        "run",
        "0xcefd64d8c1ceff131bda5fb946b0767873f9833285820037b085564d4b4de53b",
        "--rpc-url",
    ...
    .stdout_eq(str![[r#"
Traces:
  [0] 0xFc536AB2Cc1e784Ae181ca8A23b3E9C828B934A8::ced9f0ab(000000000092b75706481bbe42341006542182c1df79b4f69b3a40ade2630ea96a9a8d53b1)
    └─ ← [Stop]
...
casttest!(flaky_estimate_base_da, |_prj, cmd| {
    cmd.args(["da-estimate", "46539578", "-r", "https://mainnet.base.org/"])
        .assert_success()
        .stdout_eq(str![[r#"
Estimated data availability size for block 46539578 with 194 transactions: 38105236700
