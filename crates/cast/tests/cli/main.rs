...
Authorization #0
  ...
  Validation Status:
    Chain: VALID
    Nonce: VALID
  Code Status: ACTIVE (delegated to 0x70997970C51812dc3A010C7d01b50e0d17dc79C8)
...
Authorization #0
  ...
  Code Status: No delegation (account has no code)
...
Authorization #0
  ...
  Validation Status:
    Chain: VALID
    Nonce: VALID
  Code Status: ACTIVE (delegated to 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC)
...
Authorization #1
  ...
  Validation Status:
    Chain: VALID
    Nonce: INVALID (expected: 1, got: 0)
  Code Status: SUPERSEDED (currently delegated to 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC)
...
casttest!(validate_auth_non_eip7702_tx, async |_prj, cmd| {
    ...
    cmd.cast_fuse()
        ...
        .assert_failure()
        .stderr_eq(str![[r#"
Error: transaction is not an EIP-7702 transaction
