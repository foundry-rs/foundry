...
casttest!(
    ...
    flaky_error_decode_with_openchain,
    |prj, cmd| {
        prj.clear_cache();
...
casttest!(
    #[ignore = "flaky external API"]
    flaky_fourbyte_calldata_only_selector,
    |_prj, cmd| {
...
casttest!(
    ...
    |_prj, cmd| {
        ...
        assert!(
            output
                .contains("Function ERC20InsufficientBalance(address,uint256,uint256): 0xe450d38c"),
            "{}",
            output
...
casttest!(
    #[ignore = "flaky external API"]
    flaky_event_decode_with_openchain,
    |prj, cmd| {
        prj.clear_cache();
...
forgetest_init!(
    ...
    flaky_error_event_decode_with_cache,
    |prj, cmd| {
        prj.add_source(
...
forgetest!(
    #[ignore = "flaky cache selectors"]
    flaky_cache_selectors_from_extra_abis,
    |prj, cmd| {
