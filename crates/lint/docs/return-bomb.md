...
Depending on the compiler and optimization settings, generated code may copy returndata even
when the second tuple element is ignored. This lint does not inspect the generated bytecode.
...
Do not rely on ignoring the second tuple element without checking the generated code. If returndata is needed, copy only a
