...
contract ReturnBomb {
    ...
    bytes initializedData = this.ownDynamicReturn{gas: 10_000}(); //~WARN: external call with a gas limit consumes unbounded return data
    ...
    function ignoresReturnData(address target, bytes memory payload, uint256 gasLimit) public {
        (bool success, ) = target.call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
        require(success, "Call failed");
    }

    function standaloneLowLevelCall(address target, bytes memory payload, uint256 gasLimit) public {
        target.call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
    }

    function lowLevelCall(address target, bytes memory payload, uint256 gasLimit) public {
        (bool success, bytes memory result) = target.call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
        require(success, "Call failed");
        require(result.length >= 0);
    }

    function lowLevelCallLiteralGas(address target, bytes memory payload) public {
        (bool success, bytes memory result) = target.call{gas: 10_000}(payload); //~WARN: external call with a gas limit consumes unbounded return data
        require(success, "Call failed");
        require(result.length >= 0);
    }

    function lowLevelCallWithValue(address payable target, bytes memory payload, uint256 gasLimit, uint256 value) public {
        (bool success, bytes memory result) = target.call{value: value, gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
        require(success, "Call failed");
        require(result.length >= 0);
    }

    function delegateCall(address target, bytes memory payload, uint256 gasLimit) public {
        (bool success, bytes memory result) = target.delegatecall{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
        require(success, "Delegatecall failed");
        require(result.length >= 0);
    }

    function staticCall(address target, bytes memory payload, uint256 gasLimit) public view {
        (bool success, bytes memory result) = target.staticcall{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
        require(success, "Staticcall failed");
        require(result.length >= 0);
    }

    function msgSenderCall(bytes memory payload, uint256 gasLimit) public {
        msg.sender.call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
    }

    function blockCoinbaseCall(bytes memory payload, uint256 gasLimit) public {
        block.coinbase.call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
    }

    function txOriginCall(bytes memory payload, uint256 gasLimit) public {
        tx.origin.call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
    }
    ...
    function returnedAddressLowLevelCall(bytes memory payload, uint256 gasLimit) public {
        getAddress().call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
    }
    ...
    function ecrecoverLowLevelCall(
        ...
        ecrecover(h, v, r, s).call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
    }

    function existingBytes(address target, bytes memory payload, uint256 gasLimit) public {
        (bool success, bytes memory result) = target.call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
        (success, existingData) = target.call{gas: gasLimit}(result); //~WARN: external call with a gas limit consumes unbounded return data
        require(success, "Call failed");
    }

    function directReturn(address target, bytes memory payload, uint256 gasLimit) public returns (bool, bytes memory) {
        return target.call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
    }

    function memberBytes(address target, bytes memory payload, uint256 gasLimit) public {
        bool success;
        (success, storedResult.data) = target.call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
        require(success, "Call failed");
    }
    ...
    function indexedBytes(address target, bytes memory payload, uint256 gasLimit) public {
        bool success;
        results.push();
        (success, results[0]) = target.call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
        require(success, "Call failed");
    }

    function highLevelDynamicReturn(IReturnBombTarget target, uint256 gasLimit) public {
        bytes memory result = target.fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }

    function standaloneHighLevelDynamicReturn(IReturnBombTarget target, uint256 gasLimit) public {
        target.fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
    }

    function nestedHighLevelDynamicReturn(IReturnBombTarget target, uint256 gasLimit) public {
        require(target.fetch{gas: gasLimit}().length >= 0); //~WARN: external call with a gas limit consumes unbounded return data
    }

    function directHighLevelDynamicReturn(IReturnBombTarget target, uint256 gasLimit) public returns (bytes memory) {
        return target.fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
    }

    function highLevelDynamicStructReturn(IReturnBombStructTarget target, uint256 gasLimit) public {
        IReturnBombStructTarget.Result memory result = target.fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
    ...
    function indexedHighLevelDynamicReturn(IReturnBombTarget[] memory targets, uint256 index, uint256 gasLimit) public {
        bytes memory result = targets[index].fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }

    function mappedHighLevelDynamicReturn(uint256 index, uint256 gasLimit) public {
        bytes memory result = mappedTargets[index].fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }

    function memberHighLevelDynamicReturn(TargetSlot memory slot, uint256 gasLimit) public {
        bytes memory result = slot.target.fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function returnedTargetHighLevelDynamicReturn(uint256 gasLimit) public {
        bytes memory result = getTarget().fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function thisHighLevelDynamicReturn(uint256 gasLimit) public {
        this.ownDynamicReturn{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
    }
    ...
    function thisHighLevelDynamicReturnInModifierArgument(uint256 gasLimit)
        public
        withDynamicReturn(this.ownDynamicReturn{gas: gasLimit}()) //~WARN: external call with a gas limit consumes unbounded return data
    {}
    ...
    function highLevelDynamicReturnInIf(IReturnBombTarget target, uint256 gasLimit) public {
        if (target.fetch{gas: gasLimit}().length > 0) {} //~WARN: external call with a gas limit consumes unbounded return data
    }

    function highLevelDynamicReturnInEmit(IReturnBombTarget target, uint256 gasLimit) public {
        emit DynamicReturn(target.fetch{gas: gasLimit}()); //~WARN: external call with a gas limit consumes unbounded return data
    }

    function highLevelDynamicReturnInRevert(IReturnBombTarget target, uint256 gasLimit) public {
        revert DynamicReturnError(target.fetch{gas: gasLimit}()); //~WARN: external call with a gas limit consumes unbounded return data
    }

    function highLevelDynamicReturnInTry(IReturnBombTarget target, uint256 gasLimit) public {
        try target.fetch{gas: gasLimit}() returns (bytes memory) { //~WARN: external call with a gas limit consumes unbounded return data
        } catch {}
    }
    ...
    function overloadedDynamicReturn(
        ...
        bytes memory result = target.fetch{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function overloadedUnknownArgumentDynamicReturn(
        ...
        bytes memory result = target.fetch{gas: gasLimit}(value + 1); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function integerWideningDynamicReturn(
        ...
        bytes memory result = target.fetch{gas: gasLimit}(value); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function overloadedLiteralRangeDynamicReturn(
        ...
        bytes memory result = target.fetch{gas: gasLimit}(300); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function fixedArrayOverloadDynamicReturn(
        ...
        bytes memory result = target.fetch{gas: gasLimit}(values); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function ternaryHighLevelDynamicReturn(
        ...
        bytes memory result = (useFirst ? first : second).fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function ternaryLowLevelCall(
        ...
        (useFirst ? first : second).call{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
    }

    function castDynamicReturn(address target, uint256 gasLimit) public {
        bytes memory result = IReturnBombTarget(target).fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function castOverloadedDynamicReturn(
        ...
        bytes memory result = IReturnBombOverloadedTarget(target).fetch{gas: gasLimit}(payload); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function externalFunctionPointerDynamicReturn(
        ...
        bytes memory result = fetcher{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function externalFunctionPointerMemberDynamicReturn(
        ...
        bytes memory result = slot.fetcher{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function returnedExternalFunctionPointerDynamicReturn(uint256 gasLimit) public {
        bytes memory result = getFetcher(){gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
    ...
    function externalFunctionPointerReturnedTargetDynamicReturn(
        ...
        bytes memory result = targetGetter().fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }

    function newTargetDynamicReturn(uint256 gasLimit) public {
        bytes memory result = (new ReturnBombCreatedTarget()).fetch{gas: gasLimit}(); //~WARN: external call with a gas limit consumes unbounded return data
        require(result.length >= 0);
    }
}
