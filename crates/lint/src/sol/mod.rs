...
mod tests {
    ...
    /// This test enforces the source documentation contract. Publishing the pages targeted by
    /// the `help` URLs generated by `declare_forge_lint!` is a separate Book deployment step.
    ///
