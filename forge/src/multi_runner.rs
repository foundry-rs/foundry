                ...
                (
                    ...
                    vec![
                        ...
                        (
                            ...
                            true,
                            None,
                            Some(vec!["constructor".into(), "test, 1".into()]),
                            None,
                        ),
                        (
                            "testStrStr()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "test, test".into()]),
                            None,
                        ),
                        (
                            "testStrBool()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "test, false".into()]),
                            None,
                        ),
                        (
                            "testStrAddr()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "test, 0x0000000000000000000000000000000000000001".into()]),
                            None,
                        ),
                        (
                            "testBoolUint()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "false, 1".into()]),
                            None,
                        ),
                        (
                            "testBoolStr()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "false, test".into()]),
                            None,
                        ),
                        (
                            "testBoolBool()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "false, false".into()]),
                            None,
                        ),
                        (
                            "testBoolAddr()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "false, 0x0000000000000000000000000000000000000001".into()]),
                            None,
                        ),
                        (
                            "testAddrUint()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "0x0000000000000000000000000000000000000001, 1".into()]),
                            None,
                        ),
                        (
                            "testAddrStr()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "0x0000000000000000000000000000000000000001, test".into()]),
                            None,
                        ),
                        (
                            "testAddrBool()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "0x0000000000000000000000000000000000000001, false".into()]),
                            None,
                        ),
                        (
                            "testAddrAddr()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "0x0000000000000000000000000000000000000001, 0x0000000000000000000000000000000000000001".into()]),
                            None,
                        ),
                        (
                            "testUintUintUint()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "1, 1, 1".into()]),
                            None,
                        ),
                        (
                            "testUintUintUintUint()",
                            true,
                            None,
                            Some(vec!["constructor".into(), "1, 1, 1, 1".into()]),
                            None,
                        ),
                    ],
                ),
