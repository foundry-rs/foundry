...
through exactly one delivery method. The embedded server also honors the selected Forge profile
when indexing workspaces and running its default flychecks.
