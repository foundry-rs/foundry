impl crate::GoogleRestApi {
    pub async fn create_google_dns_v1_config(
        &self,
    ) -> crate::error::Result<crate::google_rest_apis::dns_v1::apis::configuration::Configuration>
    {
        let token = self.token_generator.create_token().await?;
        Ok(
            crate::google_rest_apis::dns_v1::apis::configuration::Configuration {
