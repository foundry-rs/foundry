...
) -> Result<crate::operation::list_key_rotations::builders::ListKeyRotationsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Rotations" => {
                    builder = builder.set_rotations(crate::protocol_serde::shape_rotations_list::de_rotations_list(tokens)?);
                }
                "NextMarker" => {
