...
pub enum Subcommands {
    ...
    #[clap(name = "logs")]
    #[clap(about = "Print the raw logs generated by an address")]
    Logs {
        #[clap(long = "block", short = 'b', parse(try_from_str = parse_block_id) )]
        block: Option<BlockId>,
        #[clap(long= "address", parse(try_from_str = parse_name_or_address))]
