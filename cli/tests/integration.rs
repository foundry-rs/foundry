use foundry_cli_test_utils::{forgetest_external, forgetest_external_forking};
...
forgetest_external_forking!(drai, "mds1/drai", 13633752);
forgetest_external_forking!(gunilev, "hexonaut/guni-lev", 13633752);
