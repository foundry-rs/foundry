...
The earlier [grammar generator](grammar/README.md) and [arithmetic measurements](RESULTS.md) remain
historical experiments, not measurements of this native mode. No native maze result is claimed
